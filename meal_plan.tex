...
\pagestyle{fancy}
\fancyhf{}
\rhead{Jonah Edmundson \\ \copyright \ 2024}
\lhead{\thepage}
...
\subsubsection{Day 3 - Meatball Sub}
\vspace{1pc}
\begin{itemize}
\item ground beef
\item oats
...
\vspace{1pc}
\begin{itemize}
\item 2L crushed tomatoes
\item 500mL chicken stock
\item 1L cream
\item 4-6 chicken breasts
...
\item jalapeno 
\item \href{https://sallysbakingaddiction.com/homemade-pizza-crust-recipe/}{pizza dough} (instant yeast, flour, sugar, salt, olive oil) 
\item garlic 
\item butter 
\item mozza cheese 
...
\subsubsection{Spaghetti \& Meatballs}
\vspace{1pc}
\begin{itemize}
